...
function SinginForm() {
    ...
    return (
        <div className='w-full h-screen flex justify-center items-center bg-transparent '>
            <Card className="w-full max-w-md shadow-[0px_0px_13px_0px_#fafafa] bg-white/10
backdrop-blur-md
border border-white/20 text-gray-200">
                <CardHeader>
                    ...
                    <CardAction >
                        Create account
                        <Button variant='link' className='text-blue-500' asChild><Link href='/' >Sign Up</Link></Button>
                    </CardAction>
                </CardHeader>
                <CardContent>
                    <form>
                        <div className='flex flex-col gap-6'>
                            ...
                            <div className='grid gap-2'>
                                ...
                                <div className='relative'>
                                    ...
                                    <button className={'absolute text-gray-500 hover:text-gray-700 right-3 top-1/2 -translate-y-1/2 bg-transparent'} type={'button'} onClick={() => setshow(!show)}>{show ? <EyeOff /> : <Eye />}</button>
                                </div>
                            </div>
                ...
                <CardFooter className={'flex flex-col gap-2 text-gray-900'} >
                    <LoadingBtn loading={provider === 'login'} loadingvalue={"LogIn..."} type={'submit'} className={'w-full hover:scale-[1.02] transition-all duration-300'} onClick={onsubmitbtn}>Login</LoadingBtn>
